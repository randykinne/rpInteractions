...
public class PunishmentManager {
    ...
    public class Punishment {
        ...
        /**
         * Get the {@link } of this punishment.
         *
         ...
         * Follows the format "{@link } until TIME for REASON."
         *
    ...
    public PunishmentManager(RPICore plugin, Configuration config, Database database) {
        this.config = config;
